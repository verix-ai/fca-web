...
const StaffPage: React.FC = () => {
    useSEO({
        title: 'Our Team | Friendly Care Agency Specialists',
        description: 'Meet the leadership team at Friendly Care Agency — dedicated professionals committed to providing compassionate, high-quality home care across Georgia.',
        path: '/staff',
    });
